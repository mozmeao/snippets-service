...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'base_clientmatchrule', 'appbuildid', self.gf('snippets.base.fields.RegexField')(max_length=255))

        # Changing field 'ClientMatchRule.locale'
        db.alter_column(u'base_clientmatchrule', 'locale', self.gf('snippets.base.fields.RegexField')(max_length=255))

        # Changing field 'ClientMatchRule.distribution_version'
        db.alter_column(u'base_clientmatchrule', 'distribution_version', self.gf('snippets.base.fields.RegexField')(max_length=255))

        # Changing field 'ClientMatchRule.startpage_version'
        db.alter_column(u'base_clientmatchrule', 'startpage_version', self.gf('snippets.base.fields.RegexField')(max_length=255))

        # Changing field 'ClientMatchRule.os_version'
        db.alter_column(u'base_clientmatchrule', 'os_version', self.gf('snippets.base.fields.RegexField')(max_length=255))

        # Changing field 'ClientMatchRule.version'
        db.alter_column(u'base_clientmatchrule', 'version', self.gf('snippets.base.fields.RegexField')(max_length=255))

        # Changing field 'ClientMatchRule.distribution'
        db.alter_column(u'base_clientmatchrule', 'distribution', self.gf('snippets.base.fields.RegexField')(max_length=255))

        # Changing field 'ClientMatchRule.build_target'
        db.alter_column(u'base_clientmatchrule', 'build_target', self.gf('snippets.base.fields.RegexField')(max_length=255))

        # Changing field 'ClientMatchRule.channel'
        db.alter_column(u'base_clientmatchrule', 'channel', self.gf('snippets.base.fields.RegexField')(max_length=255))

        # Changing field 'ClientMatchRule.name'
        db.alter_column(u'base_clientmatchrule', 'name', self.gf('snippets.base.fields.RegexField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'ClientMatchRule.appbuildid'
        db.alter_column(u'base_clientmatchrule', 'appbuildid', self.gf('snippets.base.fields.RegexField')(max_length=64))

        # Changing field 'ClientMatchRule.locale'
        db.alter_column(u'base_clientmatchrule', 'locale', self.gf('snippets.base.fields.RegexField')(max_length=64))

        # Changing field 'ClientMatchRule.distribution_version'
        db.alter_column(u'base_clientmatchrule', 'distribution_version', self.gf('snippets.base.fields.RegexField')(max_length=64))

        # Changing field 'ClientMatchRule.startpage_version'
        db.alter_column(u'base_clientmatchrule', 'startpage_version', self.gf('snippets.base.fields.RegexField')(max_length=64))

        # Changing field 'ClientMatchRule.os_version'
        db.alter_column(u'base_clientmatchrule', 'os_version', self.gf('snippets.base.fields.RegexField')(max_length=64))

        # Changing field 'ClientMatchRule.version'
        db.alter_column(u'base_clientmatchrule', 'version', self.gf('snippets.base.fields.RegexField')(max_length=64))

        # Changing field 'ClientMatchRule.distribution'
        db.alter_column(u'base_clientmatchrule', 'distribution', self.gf('snippets.base.fields.RegexField')(max_length=64))

        # Changing field 'ClientMatchRule.build_target'
        db.alter_column(u'base_clientmatchrule', 'build_target', self.gf('snippets.base.fields.RegexField')(max_length=64))

        # Changing field 'ClientMatchRule.channel'
        db.alter_column(u'base_clientmatchrule', 'channel', self.gf('snippets.base.fields.RegexField')(max_length=64))

        # Changing field 'ClientMatchRule.name'
        db.alter_column(u'base_clientmatchrule', 'name', self.gf('snippets.base.fields.RegexField')(max_length=64))
