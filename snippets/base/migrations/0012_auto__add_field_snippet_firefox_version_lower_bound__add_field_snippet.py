...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Snippet.firefox_version_lower_bound'
        db.add_column(u'base_snippet', 'firefox_version_lower_bound',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Snippet.firefox_version_upper_bound'
        db.add_column(u'base_snippet', 'firefox_version_upper_bound',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Snippet.firefox_version_lower_bound'
        db.delete_column(u'base_snippet', 'firefox_version_lower_bound')

        # Deleting field 'Snippet.firefox_version_upper_bound'
        db.delete_column(u'base_snippet', 'firefox_version_upper_bound')
    ...
    models = {
        ...
        u'base.snippet': {
            ...
            'disabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'firefox_version_lower_bound': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'firefox_version_upper_bound': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            'on_aurora': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
