    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(unique=True, max_length=255)),
                ('code', models.TextField(validators=[snippets.base.models.validate_xml_template])),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
            ],
            bases=(caching.base.CachingMixin, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template', models.ForeignKey(related_name='variable_set', to='base.SnippetTemplate')),
            ],
            options={
                'ordering': ('name',),
            },
        ...
        migrations.AddField(
            model_name='snippet',
            name='template',
            field=models.ForeignKey(to='base.SnippetTemplate'),
        ),
        migrations.AddField(
