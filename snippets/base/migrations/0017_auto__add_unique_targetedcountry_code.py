...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'TargetedCountry', fields ['code']
        db.create_unique(u'base_targetedcountry', ['code'])


    def backwards(self, orm):
        # Removing unique constraint on 'TargetedCountry', fields ['code']
        db.delete_unique(u'base_targetedcountry', ['code'])
