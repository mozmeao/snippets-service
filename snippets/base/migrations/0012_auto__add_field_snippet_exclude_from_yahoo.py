...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Snippet.exclude_from_yahoo'
        db.add_column(u'base_snippet', 'exclude_from_yahoo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Snippet.exclude_from_google'
        db.add_column(u'base_snippet', 'exclude_from_google',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Snippet.exclude_from_bing'
        db.add_column(u'base_snippet', 'exclude_from_bing',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Snippet.exclude_from_yahoo'
        db.delete_column(u'base_snippet', 'exclude_from_yahoo')

        # Deleting field 'Snippet.exclude_from_google'
        db.delete_column(u'base_snippet', 'exclude_from_google')

        # Deleting field 'Snippet.exclude_from_bing'
        db.delete_column(u'base_snippet', 'exclude_from_bing')
    ...
    models = {
        ...
        u'base.snippet': {
            ...
            'disabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'exclude_from_bing': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'exclude_from_google': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'exclude_from_yahoo': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            'on_aurora': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
