...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SearchProvider'
        db.create_table(u'base_searchprovider', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('identifier', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'base', ['SearchProvider'])

        # Adding M2M table for field exclude_from_search_providers on 'Snippet'
        db.create_table(u'base_snippet_exclude_from_search_providers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('snippet', models.ForeignKey(orm[u'base.snippet'], null=False)),
            ('searchprovider', models.ForeignKey(orm[u'base.searchprovider'], null=False))
        ))
        db.create_unique(u'base_snippet_exclude_from_search_providers', ['snippet_id', 'searchprovider_id'])


    def backwards(self, orm):
        # Deleting model 'SearchProvider'
        db.delete_table(u'base_searchprovider')

        # Removing M2M table for field exclude_from_search_providers on 'Snippet'
        db.delete_table('base_snippet_exclude_from_search_providers')
    ...
    models = {
        ...
        u'base.searchprovider': {
            'Meta': {'object_name': 'SearchProvider'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
