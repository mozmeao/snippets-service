...
# FROM https://github.com/mozilla/bedrock/blob/master/bedrock/base/tests/test_simple_dict_cache.py
...
_caches_setting_base = {
    ...
    'custom_key2': {'KEY_FUNCTION': 'snippets.base.tests.test_simple_dict_cache.custom_key_func'},
...
class SimpleDictCacheTests(TestCase):
    ...
    @override_settings(CACHES={
        'default': {'BACKEND': 'snippets.base.cache.SimpleDictCache'},
        'other': {
            'BACKEND': 'snippets.base.cache.SimpleDictCache',
            'LOCATION': 'other'
        },
