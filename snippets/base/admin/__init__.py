...
admin.site.register(models.DailyJobMetrics, adminmodels.DailyJobMetrics)
admin.site.register(models.DailySnippetsMetrics, adminmodels.DailySnippetsMetrics)
admin.site.register(models.DailyChannelMetrics, adminmodels.DailyChannelMetrics)
admin.site.register(models.DailyCountryMetrics, adminmodels.DailyCountryMetrics)
